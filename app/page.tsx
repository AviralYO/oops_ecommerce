            ...
            {[
              {
                ...
                content: "Amazing selection and prices! The delivery was super fast. Highly recommended!",
                rating: 5
              },
              {
                name: "Rajesh Singh",
                role: "Small Retailer",
                content: "Best platform to connect with wholesalers. Great discounts and reliable service.",
                rating: 5
              },
              {
                name: "Meera Patel",
                role: "First-time Buyer",
                content: "Easy to use, great quality products, and excellent customer support. Very satisfied!",
                rating: 5
              }
            ].map((testimonial, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
            <div className="md:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-lg font-bold">LiveMART</span>
              </div>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Connecting customers, retailers, and wholesalers seamlessly. Your trusted marketplace for quality products at great prices.
              </p>
            </div>
          ...
          <div className="border-t border-border pt-8 mt-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <p className="text-sm text-muted-foreground">
                © 2024 LiveMART. All rights reserved. Connecting local retailers and wholesalers across India.
              </p>
