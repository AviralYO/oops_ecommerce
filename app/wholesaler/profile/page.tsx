        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle>Wholesaler Profile</CardTitle>
                <CardDescription>Manage your wholesale business information</CardDescription>
              </div>
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-purple-500 to-indigo-500 flex items-center justify-center text-white text-3xl font-bold">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between">
                <span className="text-muted-foreground">Connected Retailers</span>
